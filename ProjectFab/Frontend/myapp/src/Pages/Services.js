    ...
    <div>
      ...
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          ...
          <img src='./Images/Fab/contkitch.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Container Kitchen</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/contkiosk.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center'>Container Kiosk</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/foodcart.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food Cart</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/portablefood.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/foodtruck.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food Truck</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/doubledecker.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/customfab.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      <div class='row pb-4'>
        ...
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/multisport.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
